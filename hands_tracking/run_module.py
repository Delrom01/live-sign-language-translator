...
from hands_tracking_module import HandsDetector
...
def main():
    ...
    while True:
        ...
        camera_image = detector.find_hands(camera_image, draw_landmarks=True)                                               # Détecter la main et dessiner la représentation
        landmarks_list = detector.find_position(camera_image, draw_positions=True, landmark_number=8)                       # Récupérer les positions des différents repères d'une main et les afficher (où une seule en particulier)
